...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex justify-content-between align-items-center flex-wrap">
            <div>
                <h4 class="page-title mb-1">User Edit</h4>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                    ...
                    <span class="text-muted small">
                        Editing user: <strong>{{ $user->first_name }} {{ $user->last_name }}</strong>
                    </span>
                </div>
                ...
                <form action="{{route('admin.users.update', $user->id)}}" method="POST" id="ajax_form">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select name="role" id="role" class="form-control">
                                    ...
                                    @foreach($roles as $role)
                                        <option value="{{$role->id}}" @if($role->id == $user->hasRole($role)) selected @endif>
                                            {{$role->name}}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <input type="submit" value="Update User" class="btn btn-success btn-submit">
                    </div>
                </form>
            </div> <!-- end card-body-->
        </div> <!-- end card-->
